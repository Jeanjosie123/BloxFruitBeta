...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('WPSHOP BF') then
        makefolder('WPSHOP BF')
    end
    if not _G.Dis and not isfile('WPSHOP BF/'..Name..'.json') then
        writefile('WPSHOP BF/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('WPSHOP BF') and isfile('WPSHOP BF/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('WPSHOP BF/'..Name..'.json'))
